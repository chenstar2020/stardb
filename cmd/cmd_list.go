...
func lPush(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) < 2 {
...
func rPush(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) < 2 {
...
func lPop(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func rPop(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func lIndex(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 2{
...
func lRem(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 3{
...
func lInsert(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 4{
	...
	var val int
	if val, err = db.LInsert([]byte(args[0]), list.InsertOption(flag), []byte(args[2]), []byte(args[3])); err == nil{
		res = redcon.SimpleInt(val)
	}
	return
}

func lSet(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 3{
...
func lTrim(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 3{
...
func lRange(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 3{
		err = newWrongNumOfArgsError("ltrim")
		return
	}
...
func lLen(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 1{
...
func lKeyExists(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 1{
...
func lValExists(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 2{
