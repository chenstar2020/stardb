...
func sAdd(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) <= 1{
...
func sPop(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 2{
...
func sIsMember(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 2{
...
func sRandMember(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 2{
...
func sRem(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) <= 1{
		err = ErrSyntaxIncorrect
		return
	}
...
func sMove(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 3{
...
func sCard(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 1{
...
func sMembers(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 1{
...
func sUnion(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) <= 0{
...
func sDiff(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) <= 0{
