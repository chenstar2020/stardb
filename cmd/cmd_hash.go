...
func hSet(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func hSetNx(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func hGet(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 2{
...
func hGetAll(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 1{
		err = ErrSyntaxIncorrect
		return
	}
...
func hDel(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) <= 1{
...
func hExists(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 2{
...
func hLen(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 1{
...
func hKeys(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 1{
		err = ErrSyntaxIncorrect
		return
	}
...
func hVals(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 1{
