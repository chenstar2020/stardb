...
func zAdd(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func zScore(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 2{
...
func zCard(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 1{
...
func zRank(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 2{
		err = newWrongNumOfArgsError("zrank")
		return
	}
...
func zrevRank(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 2{
...
func zIncrBy(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 3{
...
func zRange(db *stardb.StarDB, args []string) (res interface{}, err error) {
...
func zrevRange(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 3 && len(args) != 4{
...
func zRawRange(db *stardb.StarDB, args []string, rev bool)(res interface{}, err error){
	withScores := false
	if len(args) == 4{
...
func zRem(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 2{
...
func zGetByRank(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 2{
...
func zRevGetByRank(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 2{
...
func zRawGetByRank(db *stardb.StarDB, args []string, rev bool)(res interface{}, err error) {
...
func zScoreRange(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 3{
...
func zRevScoreRange(db *stardb.StarDB, args []string) (res interface{}, err error) {
	if len(args) != 3{
...
func zRawScoreRange(db *stardb.StarDB, args []string, rev bool)(res interface{}, err error){
	...
	if rev{
		...
		db.ZScoreRange([]byte(args[0]), param1, param2)
	}
	results := make([]string, len(val))
	for i, v := range val{
		results[i] = fmt.Sprintf("%v", v)
